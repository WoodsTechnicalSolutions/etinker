...
export ET_BOOTLOADER_BUILD_DIR := $(ET_DIR)/bootloader/build/$(ET_BOARD_TYPE)/$(ET_CROSS_TUPLE)
...
export ET_BOOTLOADER_DIR := $(ET_DIR)/bootloader/$(ET_BOARD_TYPE)/$(ET_CROSS_TUPLE)
