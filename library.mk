...
#
# Copyright (C) 2021-2026, Derald D. Woods <woods.technical@gmail.com>
#
...
export ET_LIBRARY_BUILD_DIR := $(ET_DIR)/library/build/$(ET_BOARD_TYPE)/$(ET_TOOLCHAIN_TYPE)
...
export ET_LIBRARY_DIR := $(ET_DIR)/library/$(ET_BOARD_TYPE)/$(ET_TOOLCHAIN_TYPE)
