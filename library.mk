...
CFLAGS_TEST += -I $(ET_TOOLCHAIN_DIR)/$(ET_MCU_LIBC)/$(ET_CROSS_TUPLE)/include
CFLAGS += -DETINKER_MCU_LIBC=\"$(ET_MCU_LIBC)\"
else
CFLAGS += -I $(ET_TOOLCHAIN_DIR)/$(ET_CROSS_TUPLE)/sysroot/usr/include
CFLAGS_TEST += -I $(ET_TOOLCHAIN_DIR)/$(ET_CROSS_TUPLE)/sysroot/usr/include
endif
